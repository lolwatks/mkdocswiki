...
![Regular Plan Returns Trailing by 1% - Dark Mode](/images/difference-direct-regular-one-percent.dark.png)

![Regular Plan Returns Trailing by 1% - Light Mode](/images/difference-direct-regular-one-percent.light.png)

If the difference in CAGR is assumed to be $$1.5\%$$, this is how the corpus changes.

![Regular Plan Returns Trailing by 1.5% - Dark Mode](/images/difference-direct-regular-one-point-five.dark.png)

![Regular Plan Returns Trailing by 1.5% - Light Mode](/images/difference-direct-regular-one-point-five.light.png)
