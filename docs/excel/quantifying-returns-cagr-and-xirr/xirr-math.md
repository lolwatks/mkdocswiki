...
![Verifying XIRR value from summing up discounted cashflows - Dark Mode](/images/verifying-xirr-sum-of-discounted-cashflow.dark.png)

![Verifying XIRR value from summing up discounted cashflows - Light Mode](/images/verifying-xirr-sum-of-discounted-cashflow.light.png)
...
![XIRR of only two transactions - Dark Mode](/images/xirr-only-two-transactions-hdfc.dark.png)

![XIRR of only two transactions - Light Mode](/images/xirr-only-two-transactions-hdfc.light.png)

At the same time, we could obtain CAGR of underlying asset, HDFC shares, over 5 years, which also comes out to be $$17.69\%$$ **p.a.**

![CAGR computed with RRI function - Dark Mode](/images/hdfc-5y-cagr.dark.png)

![CAGR computed with RRI function - Light Mode](/images/hdc-5y-cagr.light.png)
...
![Discounted cashflow for only two transactions - Dark Mode](/images/xirr-only-two-transactions.dark.png)

![Discounted cashflow for only two transactions - Dark Mode](/images/xirr-only-two-transactions.light.png)
...
![Discounting cashflows for XIRR in case of more that two transactions - Dark Mode](/images/xirr-multiple-transactions.dark.png)

![Discounting cashflows for XIRR in case of more that two transactions - Light Mode](/images/xirr-multiple-transactions.light.png)
...
![Cashflow and Discounted Cashflow vs Years - Dark Mode](/images/cashflow-discounted-cashflow-chart.dark.png)

![Cashflow and Discounted Cashflow vs Years - Light Mode](/images/cashflow-discounted-cashflow-chart.light.png)
